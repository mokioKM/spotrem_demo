...
class UpdateTroubleCategoryRequest extends FormRequest
{
    ...
    {
        $categoryParam = $this->route('trouble_category');
        $ignoreId = $categoryParam instanceof TroubleCategory ? $categoryParam->id : (int) $categoryParam;
        ...
        return [
            'name' => [
                ...
                'max:100',
                'regex:/^[a-z0-9_]+$/',
                Rule::unique('trouble_categories', 'name')->ignore($ignoreId),
            ],
